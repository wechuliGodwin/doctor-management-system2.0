...
<div class="flex flex-col md:flex-row-reverse min-h-screen">
    ...
    <div class="w-full md:w-3/4 p-8 bg-gradient-to-br from-gray-50 to-blue-50">
        <div class="max-w-4xl mx-auto">
            <h1 class="text-3xl font-bold text-[#1a365d] mb-6">Feature Requests</h1>
            ...
            @if($features->count())
                    ...
                    <table class="min-w-full divide-y divide-gray-200 bg-white shadow-lg rounded-lg">
                        <thead class="bg-[#159ed5] text-white">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-sm font-semibold uppercase tracking-wider">Feature</th>
                                <th scope="col" class="px-6 py-3 text-left text-sm font-semibold uppercase tracking-wider">Importance</th>
                ...
                <div class="mt-4">
                    {{ $features->links() }} <!-- Using default Laravel pagination -->
                </div>
            @else
                <p class="text-gray-600 text-center">No feature requests have been submitted yet.</p>
            @endif
        </div>
    </div>
</div>
