...
<html>
<head>
    <title>Kijabe Telemedicine - Patient</title>
...
<body>
    ...
    <div class="entry-modal" id="entry-modal">
        ...
        <div class="barton">
            <button onclick="joinRoom()" title="Join the meeting">Join Meeting</button>
        </div>
    </div>
    ...
    <script>
        ...
        // Auto-join if meeting_id is pre-set (optional)
        if (meetingId) {
            setTimeout(() => joinRoom(), 500); // Delay to ensure script.js loads
        }
    </script>
</body>
</html>
